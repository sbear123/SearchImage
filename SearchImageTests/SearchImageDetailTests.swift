...
class SearchImageDetailTests: XCTestCase {
    ...
    func testSetLabels() {
        ...
        XCTAssertEqual(cell!.date.text, "작성 시간 : 2011-10-27T21:18:00.000+09:00", "Error) Label에 \"작성 시간 : \"이 추가 되지 않음")
    }
}
